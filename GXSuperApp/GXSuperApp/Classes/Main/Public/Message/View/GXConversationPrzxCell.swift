...
class GXConversationPrzxCell: UITableViewCell, NibReusable {
    ...
    func bindCell(model: GXListUserMessagesItem?) {
        ...
        self.avatarIView.kf.setImage(with: URL(string: model.avatarPic), placeholder: UIImage.gx_defaultActivityIcon)
