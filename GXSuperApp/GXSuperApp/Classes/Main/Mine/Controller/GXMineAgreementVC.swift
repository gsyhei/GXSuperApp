...
class GXMineAgreementVC: GXBaseViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        self.requestAgreementList()
    }
    
    override func setupViewController() {
        self.navigationItem.title = "Policies and Agreements"
        self.gx_addBackBarButtonItem()
    }
    
}

private extension GXMineAgreementVC {
    func requestAgreementList() {
        MBProgressHUD.showLoading()
        let api = GXApi.normalApi(Api_agreement_list, [:], .get)
...
extension GXMineAgreementVC: UITableViewDataSource, UITableViewDelegate {
